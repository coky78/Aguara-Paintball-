...
(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      .aguara-calendar-shell{grid-column:1/-1;margin:0 0 14px;padding:14px;border:1px solid rgba(255,255,255,.10);border-radius:18px;background:linear-gradient(145deg,rgba(20,15,12,.97),rgba(10,10,10,.97));box-shadow:0 18px 45px rgba(0,0,0,.25)}
      ...
      .aguara-calendar-nav button{width:34px;height:34px;border:1px solid rgba(255,255,255,.14);border-radius:12px;background:#231812;color:#fff;cursor:pointer;font-size:1.15rem;font-weight:800}
      ...
      .aguara-calendar-weekday{padding:4px 0;text-align:center;font-size:.72rem;color:rgba(255,255,255,.55);font-weight:800;text-transform:uppercase}
      .aguara-day{position:relative;min-height:50px;border:1px solid rgba(255,255,255,.10);border-radius:12px;background:#000;color:#fff;cursor:pointer;padding:8px 6px;display:flex;align-items:center;justify-content:center;transition:transform .15s ease,border-color .15s ease,background .15s ease}
      ...
      .aguara-day.is-reserved-day .aguara-day-x{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;color:rgba(139,0,0,.80);font-size:2.05rem;font-weight:900;line-height:1;z-index:2;pointer-events:none}
      ...
      .aguara-day-number{position:relative;z-index:2;font-size:.92rem;font-weight:900;margin-top:10px}
      ...
      .aguara-calendar-status{margin-top:10px;padding:8px 10px;border-radius:11px;background:rgba(0,0,0,.23);font-size:.86rem;color:rgba(255,255,255,.78)}
      .aguara-time-panel{margin-top:11px;padding-top:11px;border-top:1px solid rgba(255,255,255,.08)}
      .aguara-time-title{margin:0 0 10px;font-size:.92rem;font-weight:800}
      .aguara-time-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}
      .aguara-time-card{position:relative;border:1px solid rgba(255,255,255,.12);border-radius:10px;background:rgba(56,142,60,.78);color:#000;padding:9px 10px;text-align:left;cursor:pointer;font-weight:800}
      ...
      .aguara-time-card.is-reserved{background:rgba(198,40,40,.82);border-color:rgba(244,67,54,.95);color:#fff;cursor:not-allowed;padding-top:18px;overflow:hidden}
      .aguara-time-card.is-reserved::before{content:"✕";position:absolute;inset:0;display:flex;align-items:center;justify-content:center;color:rgba(139,0,0,.82);font-size:2rem;font-weight:900;line-height:1;z-index:2;pointer-events:none}
      .aguara-time-card.is-reserved small{color:#ff8989}
      @media(max-width:640px){.aguara-calendar-shell{padding:11px;border-radius:13px}.aguara-day{min-height:44px;padding:5px 3px}.aguara-day-number{font-size:.92rem}.aguara-day-label{font-size:.38rem}.aguara-time-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
    `;
