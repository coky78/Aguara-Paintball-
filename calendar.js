...
(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .aguara-day{position:relative;min-height:60px;border:1px solid rgba(255,255,255,.10);border-radius:12px;background:#000;color:#fff;cursor:pointer;padding:8px 6px;display:flex;align-items:center;justify-content:center;transition:transform .15s ease,border-color .15s ease,background .15s ease}
      ...
      .aguara-time-card{position:relative;border:1px solid rgba(255,255,255,.12);border-radius:12px;background:rgba(56,142,60,.78);color:#000;padding:11px 12px;text-align:left;cursor:pointer;font-weight:800}
      .aguara-time-card small{display:block;margin-top:2px;font-size:.66rem;font-weight:700;color:rgba(255,255,255,.55)}
      .aguara-time-card.is-selected{border-color:#f08a35;background:#66bb6a;color:#000}
      ...
      @media(max-width:640px){.aguara-calendar-shell{padding:13px;border-radius:15px}.aguara-day{min-height:50px;padding:6px 4px}.aguara-day-number{font-size:.92rem}.aguara-day-label{font-size:.38rem}.aguara-time-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
    `;
